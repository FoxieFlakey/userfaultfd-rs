...
pub const UFFD_API_RANGE_IOCTLS: u64 =
    1 << _UFFDIO_WAKE | 1 << _UFFDIO_COPY | 1 << _UFFDIO_ZEROPAGE | 1 << _UFFDIO_MOVE | 1 << _UFFDIO_WRITEPROTECT;
...
pub const UFFDIO_MOVE_MODE_ALLOW_SRC_HOLE: u64 = 1 << 1;
...
pub const UFFDIO_MOVE: u32 = iowr::<uffdio_move>(UFFDIO as u32, _UFFDIO_MOVE as u32);
